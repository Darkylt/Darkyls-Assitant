...
function addRandomFood() {
    var canvas = document.getElementById("canvas"); // Replace "yourCanvasId" with the ID of your canvas element
...
setInterval(addRandomFood, 5000); // Call addFood every second (1000 milliseconds)
